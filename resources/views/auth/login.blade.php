@extends('layouts.main', ['class' => 'off-canvas-sidebar', 'activePage' => 'login', 'title' => __('GESTOR DE ARCHIVOS')])
          ...
          <div class="card-body">
            ...
            <div class="bmd-form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
              <div class="input-group">
                ...
                <input type="email" name="email" class="form-control" placeholder="{{ __('ejemplo@box.com') }}" value="{{ old('email', null) }}" required autocomplete="email" autofocus>
              </div>
              @if ($errors->has('email'))
